    ...
    <>
      ...
      <div className=''>
        ...
        <div className='container pt-[60px]'>
          ...
          <div className='md:py-[40px] prose mx-auto'>
            <p>
              At Meliora Lifestyle Weddings, accessible from
              https://www.melioralifestyleweddings.com, one of our main priorities is the privacy of
              our visitors. This Privacy Policy document contains types of information that is
              collected and recorded by Meliora Lifestyle Weddings and how we use it.
            </p>
            ...
            <p>
              ...
              our website with regards to the information that they shared and/or collect in Meliora
              Lifestyle Weddings. This policy is not applicable to any information collected offline
              or via channels other than this website.
            </p>

            <h2 className='text-h5 font-heading uppercase'>Consent</h2>

            <p>
              By using our website, you hereby consent to our Privacy Policy and agree to its terms.
            </p>

            <h2 className='text-h5 font-heading uppercase'>Information we collect</h2>
            ...
            <h2 className='text-h5 font-heading uppercase'>How we use your information</h2>
            ...
            <h2 className='text-h5 font-heading uppercase'>Log Files</h2>

            <p>
              Meliora Lifestyle Weddings follows a standard procedure of using log files. These
              files log visitors when they visit websites. All hosting companies do this and a part
            ...
            <h2 className='text-h5 font-heading uppercase'>Cookies and Web Beacons</h2>

            <p>
              Like any other website, Meliora Lifestyle Weddings uses &#39;cookies&#39;. These cookies are
            ...
            <h2 className='text-h5 font-heading uppercase'>Google DoubleClick DART Cookie</h2>
            ...
            <h2 className='text-h5 font-heading uppercase'>Our Advertising Partners</h2>
            ...
            <p>
              ...
              Meliora Lifestyle Weddings, which are sent directly to users&#39; browser. They
            ...
            <p>
              Note that Meliora Lifestyle Weddings has no access to or control over these cookies
              that are used by third-party advertisers.
            </p>

            <h2 className='text-h5 font-heading uppercase'>Third Party Privacy Policies</h2>

            <p>
              Meliora Lifestyle Weddings&#39;s Privacy Policy does not apply to other advertisers or
            ...
            <h2 className='text-h5 font-heading uppercase'>GDPR Data Protection Rights</h2>
            ...
            <h2 className='text-h5 font-heading uppercase'>Children&#39;s Information</h2>
            ...
            <p>
              Meliora Lifestyle Weddings does not knowingly collect any Personal Identifiable
            ...
            <h2 className='text-h5 font-heading uppercase'>Changes to This Privacy Policy</h2>
            ...
            <h2 className='text-h5 font-heading uppercase'>Contact Us</h2>
