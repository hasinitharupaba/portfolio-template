      ...
      <div className=''>
        ...
        <div className='container pt-[60px]'>
          ...
          <div className='md:py-[40px] prose mx-auto'>
            <p>
              These terms and conditions outline the rules and regulations for the use of Meliora
              Lifestyle&#39;s Website, located at https://www.melioralifestyleweddings.com. ``
            </p>

            <p>
              By accessing this website we assume you accept these terms and conditions. Do not
              continue to use Meliora Lifestyle Weddings if you do not agree to take all of the
            ...
            <h3 className='text-h5 font-heading uppercase'>
              <strong>Cookies</strong>
            </h3>

            <p>
              We employ the use of cookies. By accessing Meliora Lifestyle Weddings, you agreed to
              use cookies in agreement with the Meliora Lifestyle&#39;s Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Meliora Lifestyle and/or its licensors own the intellectual
              property rights for all material on Meliora Lifestyle Weddings. All intellectual
              property rights are reserved. You may access this from Meliora Lifestyle Weddings for
              your own personal use subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Meliora Lifestyle Weddings</li>
              <li>Sell, rent or sub-license material from Meliora Lifestyle Weddings</li>
              <li>Reproduce, duplicate or copy material from Meliora Lifestyle Weddings</li>
              <li>Redistribute content from Meliora Lifestyle Weddings</li>
            </ul>
            ...
            <p>
              ...
              information in certain areas of the website. Meliora Lifestyle does not filter, edit,
              publish or review Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Meliora Lifestyle,its agents and/or affiliates.
              Comments reflect the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Meliora Lifestyle shall not be
            ...
            <p>
              Meliora Lifestyle reserves the right to monitor all Comments and to remove any
            ...
            <p>
              You hereby grant Meliora Lifestyle a non-exclusive license to use, reproduce, edit and
            ...
            <p>
              ...
              from the visibility of the hyperlink compensates the absence of Meliora Lifestyle; and
            ...
            <p>
              ...
              linking to our website, you must inform us by sending an e-mail to Meliora Lifestyle.
            ...
            <p>
              No use of Meliora Lifestyle&#39;s logo or other artwork will be allowed for linking absent
